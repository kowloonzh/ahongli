...
以下是正式3%策略Top10及其前瞻分红结果。股价、排名和预测均为特定日期快照；成分股、财务数据和因子分位会变化，不应把本表当作当前推荐名单。

| 排名 | 公司 | 得分 | 股价 | 预期分红 | 预期股息率 | 下次派息日 | 当前位置 | 目标股息率区间 | 目标价格区间 |
|---:|---|---:|---:|---:|---:|---|---|---:|---:|
| 1 | 中国平安 | 82.62 | 57.23 | 2.9020 | 5.07% | 2026-09-10 | 进入目标区间 | 5.00%–7.00% | 41.46–58.04 |
...
| 6 | 上海银行 | 62.35 | 9.68 | 0.5148 | 5.32% | 待实施公告 | 未达目标区间 | 5.50%–7.00% | 7.35–9.36 |
| 7 | 工商银行 | 57.42 | 8.15 | 0.3150 | 3.86% | 待实施公告 | 未达目标区间 | 6.50%–8.00% | 3.94–4.85 |
| 8 | 中国移动 | 57.08 | 99.89 | 4.5585 | 4.56% | — | 未达目标区间 | 5.50%–7.50% | 60.78–82.88 |
| 9 | 中国电信 | 54.79 | 6.47 | 0.2440 | 3.77% | 待实施公告 | 未达目标区间 | 6.00%–8.00% | 3.05–4.07 |
| 10 | 建设银行 | 53.52 | 11.09 | 0.3976 | 3.58% | 待实施公告 | 未达目标区间 | 6.50%–8.00% | 4.97–6.12 |

本次运行：300个沪深300成分中，45个通过市场预筛、15个通过结构化硬门槛，最终选出Top10。完整性验证包括：
...
前瞻分析完成后，主CLI和默认 `run_pipeline()` API都会直接打印前瞻Top10主表，展示正式排名、公司、综合得分、A股价格、预期分红、预期股息率、下次派息日、当前位置、目标股息率区间和目标价格区间。确切派息日只来自正式公告；只有方案时显示“待实施公告”，没有合格事件时显示“—”。登记日、除息日、事件ID和来源ID保留在CSV及公司详情。该阶段只读取正式Top10，不修改原有300只CSV、Top10排名、得分或硬门槛。它从原始财报、分红公告和股东回报政策生成逐公司证据包，并额外输出：

最新真实Top10见本文顶部。要求总回报率、可持续分红增长率、DPS低/基准/高情景、预测依据和证据完整性保留在CSV及逐公司详情页。
